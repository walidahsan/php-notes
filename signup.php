...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql1 = "INSERT INTO `users` (`userid`, `email`, `password`) VALUES (NULL, '$username2', '$password2')";

        $sign = mysqli_query($conn, $sql1);
        if ($sign) {
            $logverify = true;
        }
    }
    ...
    if ($logverify) {
        ...
        <strong>Successfull</strong> signed up successfully
    ...
    <div class="container ">
        ...
        <div class="row mt-4 ">
            ...
            <div class="col-lg-4 shadow-lg rounded p-4">
                <h4 class="text-primary text-uppercase text-center">Signup Here</h4>
                <hr />
